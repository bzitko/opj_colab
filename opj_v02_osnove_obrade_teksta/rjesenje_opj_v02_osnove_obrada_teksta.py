...
def match_pattern(txt, patten):
    ...
    u tekstu
    """
    return re.findall(patten, txt)

def split_pattern(txt, patten):
    """
    ulaz:
    -txt: tekst
    -pattern: regularni izraz
...
def test(func, input, output = None):
    ...
    print('{}\t{}{} ==> \n{}\n == \n{}\n'.format(success, func.__name__, reformat(input_copy), reformat(output), (result)))
...
test(split_pattern, ('b**2-49ac', r'\d+'), ['b**', '-', 'ac'])
test(split_pattern, ('b**2-49ac', r'\D+'), ['', '2', '49', ''])

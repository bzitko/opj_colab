...
class NBClassifier(object):
    ...
    def train(self, labeled_data):
        ...
        ************************************************************
        ...
        self.prior = {}
        self.likelihood = {}
        self.featurevalues = {} # ovo je vocabulary
...
def evaluate_classifier(train_data, test_data, features_factory, slice_features, slice_errors, output = None):
    ...
    if output is not None:
        ...
        print("[%s]\tAccuracy: %d/%d = %.3f%%\n\t\tExpected: %d/%d = %.3f%%" % 
            (success, count_good, count_all, count_good/count_all, output[0], output[1], output[0]/output[1]*100))
    else:
...
def make_letter_features(word):
    ...
    """
    return {}
evaluate_classifier(train_data, test_data, make_letter_features, 10, 10, (1475,1987))
...
evaluate_classifier(train_data, test_data, make_suffix_features, 10, 10, (1552,1987))

# CUSTOM EVALUATING
def make_custom_features(word):
    "ovdje napraviti vlastiti skup osobina kako bi se povečala točnost klasifikatora"
    return {}

evaluate_classifier(train_data, test_data, make_custom_features, 10, 10)
